...
# dropdown = DropDown()
# languages = []
# with open('test123e.txt', 'r', encoding='utf-8') as f:
#     for line in f:
...
#     # the area it needs.
#     btn = Button(text=languages[index], size_hint_y=None, height=44, size_hint_x=None, width=200)
...
# mainbutton = Button(text='Hello', size_hint_y=None, height=44, size_hint_x=None, width=200)
